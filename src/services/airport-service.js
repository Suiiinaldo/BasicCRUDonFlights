...
async function destroyAirport(id)
{
    try {
        ...
        throw new AppError('Cannot destroy data of the requested airport',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
...
async function updateAirport(data,id)
{
    try {
        ...
        if(error.statusCodes == StatusCodes.NOT_FOUND){
            throw new AppError("The airport you requested to update is not present ", error.statusCodes);
        }
        throw new AppError('Cannot update data of the requested airport',StatusCodes.INTERNAL_SERVER_ERROR);
    }
}
